...
func show_message(message: String):
	...
	$CanvasLayer/ColorRect.position.y = (viewport_size.y / 2) - (target_size_y / 2)
	...
	tween_in.tween_property($CanvasLayer/ColorRect, "position", Vector2(rect_position.x , rect_position.y - target_size_y / 2), animation_time)
	...
	tween_out.tween_property($CanvasLayer/ColorRect, "position", Vector2(rect_position.x , rect_position.y + target_size_y / 2), animation_time)
	tween_out.tween_property($CanvasLayer/ColorRect, "size", Vector2(size.x, 0), animation_time / 2)
